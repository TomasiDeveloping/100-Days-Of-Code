...
let highlightedParagrah = document.querySelector('.highlighted-paragraph');
console.dir(highlightedParagrah);

// 5. BONUS TASK: Try changing the text content of the <p> element
//    you selected in (4) and set it to any other text of your choice

highlightedParagrah.textContent = 'This was changed by JavaScript';